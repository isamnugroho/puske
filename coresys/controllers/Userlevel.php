...
class Userlevel extends CI_Controller
{
    ...
    public function index()
    {
		...
		return view('pages/userlevel/tbl_user_level_list', $this->data);
    } 
    ...
    function akses(){
        $this->data['level'] = $this->db->get_where('tbl_user_level',array('id_user_level'=>  $this->uri->segment(3)))->row_array();
        $this->data['menu'] = $this->db->get('tbl_menu')->result();
        // $this->template->load('template','userlevel/akses',$data);
		return view('pages/userlevel/akses', $this->data);
    }
    ...
    public function create() 
    {
		...
		$this->data['action'] 			= site_url('userlevel/create_action');
		$this->data['id_user_level'] 	= set_value('id_user_level');
		$this->data['nama_level']		= set_value('nama_level');
		
        // $this->template->load('template','userlevel/tbl_user_level_form', $data);
		return view('pages/userlevel/tbl_user_level_form', $this->data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
			...
			$this->data['action'] 			= site_url('userlevel/update_action');
			$this->data['id_user_level'] 	= set_value('id_user_level', $row->id_user_level);
			$this->data['nama_level']		= set_value('nama_level', $row->nama_level);
