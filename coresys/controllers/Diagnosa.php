...
class Diagnosa extends CI_Controller
{
    ...
    {
		return view('pages/diagnosa/tbl_diagnosa_penyakit_list', $this->data);
    } 
    ...
    public function create() 
    {
		...
		$this->data['action'] 				= site_url('diagnosa/create_action');
		$this->data['kode_diagnosa'] 		= set_value('kode_diagnosa');
		$this->data['nama_penyakit'] 		= set_value('nama_penyakit');
		$this->data['ciri_ciri_penyakit'] 	= set_value('ciri_ciri_penyakit');
		$this->data['keterangan'] 			= set_value('keterangan');
		$this->data['ciri_ciri_umum'] 		= set_value('ciri_ciri_umum');
		
		return view('pages/diagnosa/tbl_diagnosa_penyakit_form', $this->data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
			...
			$this->data['action'] 				= site_url('diagnosa/update_action');
			$this->data['kode_diagnosa'] 		= set_value('kode_diagnosa', $row->kode_diagnosa);
			$this->data['nama_penyakit'] 		= set_value('nama_penyakit', $row->nama_penyakit);
			$this->data['ciri_ciri_penyakit'] 	= set_value('ciri_ciri_penyakit', $row->ciri_ciri_penyakit);
			$this->data['keterangan'] 			= set_value('keterangan', $row->keterangan);
			$this->data['ciri_ciri_umum'] 		= set_value('ciri_ciri_umum', $row->ciri_ciri_umum);
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$old_kode_diagnosa = $this->input->post('old_kode_diagnosa', TRUE);
            $data = array(
				'kode_diagnosa' => $this->input->post('kode_diagnosa', TRUE),
				'nama_penyakit' => $this->input->post('nama_penyakit',TRUE),
				'ciri_ciri_penyakit' => $this->input->post('ciri_ciri_penyakit',TRUE),
            ...
            $this->Tbl_diagnosa_penyakit_model->update($old_kode_diagnosa, $data);
