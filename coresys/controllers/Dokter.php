...
class Dokter extends CI_Controller
{
    ...
    {
		return view('pages/dokter/tbl_dokter_list', $this->data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
			...
			return view('pages/dokter/tbl_dokter_read', $this->data);
        } else {
    ...
    public function create() 
    {
		...
		$this->data['action'] 				= site_url('dokter/create_action');
		...
		$this->data['nomor_induk_dokter'] 	= set_value('nomor_induk_dokter');
		$this->data['tempat_lahir'] 		= set_value('tempat_lahir');
		$this->data['tgl_lahir'] 			= set_value('tgl_lahir');
		$this->data['alamat'] 				= set_value('alamat');
		$this->data['id_poli'] 				= set_value('id_poli');
		
		return view('pages/dokter/tbl_dokter_form', $this->data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
			...
			$this->data['action'] 				= site_url('dokter/update_action');
			$this->data['kode_dokter'] 			= set_value('kode_dokter', $row->kode_dokter);
			$this->data['nama_dokter'] 			= set_value('nama_dokter', $row->nama_dokter);
			$this->data['jenis_kelamin'] 		= set_value('jenis_kelamin', $row->jenis_kelamin);
			$this->data['nomor_induk_dokter'] 	= set_value('nomor_induk_dokter', $row->nomor_induk_dokter);
			$this->data['tempat_lahir'] 		= set_value('tempat_lahir', $row->tempat_lahir);
			$this->data['tgl_lahir'] 			= set_value('tgl_lahir', date('Y-m-d', strtotime($row->tgl_lahir)));
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$old_kode_dokter = $this->input->post('old_kode_dokter',TRUE);
            $data = array(
				'kode_dokter' => $this->input->post('kode_dokter',TRUE),
				'nama_dokter' => $this->input->post('nama_dokter',TRUE),
				'jenis_kelamin' => $this->input->post('jenis_kelamin',TRUE),
            ...
            $this->Tbl_dokter_model->update($old_kode_dokter, $data);
