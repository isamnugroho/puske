...
class Pegawai extends CI_Controller
{
    ...
    public function index()
    {
		...
		return view('pages/pegawai/tbl_pegawai_list', $this->data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
			...
			$this->data['id_pegawai'] 		= $row->id_pegawai;
			$this->data['nama_pegawai'] 	= $row->nama_pegawai;
			...
			$this->data['id_bidang'] 		= $row->id_bidang;
			
            // $this->template->load('template','pegawai/tbl_pegawai_read', $data);
			return view('pages/pegawai/tbl_pegawai_read', $this->data);
        } else {
    ...
    public function create() 
    {
		...
		$this->data['id_pegawai'] 		= set_value('id_pegawai');
		$this->data['nama_pegawai'] 	= set_value('nama_pegawai');
		$this->data['jenis_kelamin'] 	= set_value('jenis_kelamin');
		$this->data['npwp'] 			= set_value('npwp');
		...
		return view('pages/pegawai/tbl_pegawai_form', $this->data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
			...
			$this->data['id_pegawai'] 		= set_value('id_pegawai', $row->id_pegawai);
			$this->data['nama_pegawai'] 	= set_value('nama_pegawai', $row->nama_pegawai);
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$old_id_pegawai = $this->input->post('old_id_pegawai',TRUE);
            $data = array(
				'id_pegawai' => $this->input->post('id_pegawai',TRUE),
				'nama_pegawai' => $this->input->post('nama_pegawai',TRUE),
				'jenis_kelamin' => $this->input->post('jenis_kelamin',TRUE),
			...
			// print_r($old_id_pegawai);
			// print_r($data);

            $this->Tbl_pegawai_model->update($old_id_pegawai, $data);
