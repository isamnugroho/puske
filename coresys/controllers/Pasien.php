...
class Pasien extends CI_Controller
{
    ...
    {
        return view('pages/pasien/tbl_pasien_list', $this->data);
    }
    ...
    function cetakkartu($id){
        ...
        $tgl=date('Y/m/d');
        $pdf->Image('http://localhost/2021/puskesmas/assets/foto_profil/latar-kartu.jpg',5,5,100,56);
        $pdf->Image('http://localhost/2021/puskesmas/assets/foto_profil/latar-kartu.jpg',106,5,100,56);
        $pdf->Image('http://localhost/2021/puskesmas/assets/foto_profil/logo-rs.jpg',10,9,10,10);
    ...
    public function create() 
    {
		...
		$this->data['action'] 				= site_url('pasien/create_action');
		$this->data['no_rekamedis'] 		= set_value('no_rekamedis', $noRekammedisbaru);
		$this->data['no_ktp'] 				= set_value('no_ktp');
		...
		return view('pages/pasien/tbl_pasien_form', $this->data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
			...
			$this->data['no_rekamedis'] 		= set_value('no_rekamedis', $row->no_rekamedis);
			$this->data['no_ktp'] 				= set_value('no_ktp', $row->no_ktp);
