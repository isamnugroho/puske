...
class Poli extends CI_Controller
{
    ...
    {
        return view('pages/poli/tbl_poli_list', $this->data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
			...
			return view('pages/poli/tbl_poli_read', $this->data);
        } else {
    ...
    public function create() 
    {
		...
		$this->data['action'] 				= site_url('poli/create_action');
		$this->data['id_poli'] 				= set_value('id_poli');
		$this->data['nama_poli'] 			= set_value('nama_poli');
		$this->data['ruang_poli'] 			= set_value('ruang_poli');
	
		return view('pages/poli/tbl_poli_form', $this->data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
			...
			$this->data['action'] 				= site_url('poli/update_action');
			$this->data['id_poli'] 				= set_value('id_poli', $row->id_poli);
			$this->data['nama_poli'] 			= set_value('nama_poli', $row->nama_poli);
			$this->data['ruang_poli'] 			= set_value('ruang_poli', $row->ruang_poli);
