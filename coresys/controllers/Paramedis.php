...
class Paramedis extends CI_Controller
{
    ...
    public function index()
    {
		...
		return view('pages/paramedis/tbl_paramedis_list', $this->data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
			$this->data['kode_paramedis'] 		= $row->kode_paramedis;
			$this->data['nama_paramedis'] 		= $row->nama_paramedis;
			$this->data['jenis_kelamin'] 		= $row->jenis_kelamin;
			$this->data['no_izin_paramedis'] 	= $row->no_izin_paramedis;
			$this->data['tempat_lahir'] 		= $row->tempat_lahir;
			$this->data['tanggal_lahir'] 		= $row->tanggal_lahir;
			$this->data['alamat_tinggal'] 		= $row->alamat_tinggal;
			$this->data['id_poli'] 				= $row->id_poli;
            // $this->template->load('template','paramedis/tbl_paramedis_read', $data);
			return view('pages/paramedis/tbl_paramedis_read', $this->data);
        } else {
    ...
    public function create() 
    {
		...
		$this->data['action'] 				= site_url('paramedis/create_action');
		$this->data['kode_paramedis'] 		= set_value('kode_paramedis');
		$this->data['nama_paramedis'] 		= set_value('nama_paramedis');
		$this->data['jenis_kelamin'] 		= set_value('jenis_kelamin');
		$this->data['no_izin_paramedis'] 	= set_value('no_izin_paramedis');
		$this->data['tempat_lahir'] 		= set_value('tempat_lahir');
		$this->data['tanggal_lahir'] 		= set_value('tanggal_lahir');
		$this->data['alamat_tinggal'] 		= set_value('alamat_tinggal');
		$this->data['id_poli'] 				= set_value('id_poli');
		
        // $this->template->load('template','paramedis/tbl_paramedis_form', $data);
		return view('pages/paramedis/tbl_paramedis_form', $this->data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
			...
			$this->data['action'] 				= site_url('paramedis/update_action');
			$this->data['kode_paramedis'] 		= set_value('kode_paramedis', $row->kode_paramedis);
			$this->data['nama_paramedis'] 		= set_value('nama_paramedis', $row->nama_paramedis);
			$this->data['jenis_kelamin'] 		= set_value('jenis_kelamin', $row->jenis_kelamin);
			$this->data['no_izin_paramedis'] 	= set_value('no_izin_paramedis', $row->no_izin_paramedis);
			$this->data['tempat_lahir'] 		= set_value('tempat_lahir', $row->tempat_lahir);
			$this->data['tanggal_lahir'] 		= set_value('tanggal_lahir', date('Y-m-d', strtotime($row->tanggal_lahir)));
			$this->data['alamat_tinggal'] 		= set_value('alamat_tinggal', $row->alamat_tinggal);
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$tt = $this->input->post('tanggal_lahir',TRUE);
			$old_kode_paramedis = $this->input->post('old_kode_paramedis',TRUE);
            $data = array(
				'kode_paramedis' => $this->input->post('kode_paramedis',TRUE),
				'nama_paramedis' => $this->input->post('nama_paramedis',TRUE),
				'jenis_kelamin' => $this->input->post('jenis_kelamin',TRUE),
            ...
            $this->Tbl_paramedis_model->update($old_kode_paramedis, $data);
