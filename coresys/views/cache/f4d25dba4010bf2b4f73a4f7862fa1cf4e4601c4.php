...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="<?=BASE_URL?>assets/css/themes/theme-style8.css" type="text/css" id="skin_color">
	...
	<body>
					...
					<div class="col-md-4 col-sm-4">
						...
						<div class="blog-photo-stream margin-bottom-30">
							<ul class="list-unstyled">
								<li>
									<a href="#"><img alt="" src="<?=BASE_URL?>assets/images/image01_th.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?=BASE_URL?>assets/images/image02_th.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?=BASE_URL?>assets/images/image03_th.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?=BASE_URL?>assets/images/image04_th.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?=BASE_URL?>assets/images/image05_th.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?=BASE_URL?>assets/images/image06_th.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?=BASE_URL?>assets/images/image07_th.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?=BASE_URL?>assets/images/image08_th.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?=BASE_URL?>assets/images/image09_th.jpg"></a>
								</li>
								<li>
									<a href="#"><img alt="" src="<?=BASE_URL?>assets/images/image10_th.jpg"></a>
								</li>
							</ul>
						</div>
					</div>
						...
						<div class="tab-pane active" id="users">
							<div class="users-list">
								...
								<ul class="media-list">
									<li class="media">
										<a href="#">
											...
											<img alt="..." src="<?=BASE_URL?>assets/images/avatar-2.jpg" class="media-object">
									...
									<li class="media">
										<a href="#">
											...
											<i class="fa fa-circle status-online"></i>
											<img alt="..." src="<?=BASE_URL?>assets/images/avatar-3.jpg" class="media-object">
											<div class="media-body">
									...
									<li class="media">
										<a href="#">
											<i class="fa fa-circle status-online"></i>
											<img alt="..." src="<?=BASE_URL?>assets/images/avatar-4.jpg" class="media-object">
											<div class="media-body">
									...
									<li class="media">
										<a href="#">
											<i class="fa fa-circle status-online"></i>
											<img alt="..." src="<?=BASE_URL?>assets/images/avatar-5.jpg" class="media-object">
											<div class="media-body">
								...
								<ul class="media-list">
									<li class="media">
										<a href="#">
											<img alt="..." src="<?=BASE_URL?>assets/images/avatar-6.jpg" class="media-object">
											<div class="media-body">
												<h4 class="media-heading">Nicole Bell</h4>
												<span> Content Designer </span>
											</div>
									...
									<li class="media">
										<a href="#">
											...
											<img alt="..." src="<?=BASE_URL?>assets/images/avatar-7.jpg" class="media-object">
											<div class="media-body">
												<h4 class="media-heading">Steven Thompson</h4>
												<span> Visual Designer </span>
											</div>
									...
									<li class="media">
										<a href="#">
											<img alt="..." src="<?=BASE_URL?>assets/images/avatar-8.jpg" class="media-object">
											<div class="media-body">
												<h4 class="media-heading">Ella Patterson</h4>
												<span> Web Editor </span>
											</div>
									...
									<li class="media">
										<a href="#">
											<img alt="..." src="<?=BASE_URL?>assets/images/avatar-9.jpg" class="media-object">
											<div class="media-body">
												<h4 class="media-heading">Kenneth Ross</h4>
												<span> Senior Designer </span>
											</div>
									...
									<li class="media">
										<a href="#">
											<img alt="..." src="<?=BASE_URL?>assets/images/avatar-10.jpg" class="media-object">
											<div class="media-body">
												<h4 class="media-heading">Ella Patterson</h4>
												<span> Web Editor </span>
											</div>
					...
					<div class="hidden-xs" id="style_selector">
						<div id="style_selector_container">
							...
							<div class="images icons-color">
								<a href="#" id="default"><img src="<?=BASE_URL?>assets/images/color-1.png" alt="" class="active"></a>
								<a href="#" id="style2"><img src="<?=BASE_URL?>assets/images/color-2.png" alt=""></a>
								<a href="#" id="style3"><img src="<?=BASE_URL?>assets/images/color-3.png" alt=""></a>
								<a href="#" id="style4"><img src="<?=BASE_URL?>assets/images/color-4.png" alt=""></a>
								<a href="#" id="style5"><img src="<?=BASE_URL?>assets/images/color-5.png" alt=""></a>
								<a href="#" id="style6"><img src="<?=BASE_URL?>assets/images/color-6.png" alt=""></a>
								<a href="#" id="style7"><img src="<?=BASE_URL?>assets/images/color-7.png" alt=""></a>
								<a href="#" id="style8"><img src="<?=BASE_URL?>assets/images/color-8.png" alt=""></a>
								<a href="#" id="style9"><img src="<?=BASE_URL?>assets/images/color-9.png" alt=""></a>
								<a href="#" id="style10"><img src="<?=BASE_URL?>assets/images/color-10.png" alt=""></a>
							</div>
							<div class="box-title">
								Backgrounds for Boxed Version
							</div>
							<div class="images boxed-patterns">
								<a href="#" id="bg_style_1"><img src="<?=BASE_URL?>assets/images/bg.png" alt=""></a>
								<a href="#" id="bg_style_2"><img src="<?=BASE_URL?>assets/images/bg_2.png" alt=""></a>
								<a href="#" id="bg_style_3"><img src="<?=BASE_URL?>assets/images/bg_3.png" alt=""></a>
								<a href="#" id="bg_style_4"><img src="<?=BASE_URL?>assets/images/bg_4.png" alt=""></a>
								<a href="#" id="bg_style_5"><img src="<?=BASE_URL?>assets/images/bg_5.png" alt=""></a>
							</div>
						...
						<div class="e-slider owl-carousel owl-theme">
							<div class="item">
								...
								<div class="panel-footer">
									<div class="avatar-note"><img src="<?=BASE_URL?>assets/images/avatar-2-small.jpg" alt="">
									</div>
							...
							<div class="item">
								...
								<div class="panel-footer">
									<div class="avatar-note"><img src="<?=BASE_URL?>assets/images/avatar-3-small.jpg" alt="">
									</div>
							...
							<div class="item">
								...
								<div class="panel-footer">
									<div class="avatar-note"><img src="<?=BASE_URL?>assets/images/avatar-4-small.jpg" alt="">
									</div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<div class="fileupload fileupload-new contributor-avatar" data-provides="fileupload">
										<div class="fileupload-new thumbnail"><img src="<?=BASE_URL?>assets/images/anonymous.jpg" alt="" width="50" height="50"/>
										</div>
		...
		<script src="<?=BASE_URL?>assets/js/subview.js"></script>
	...
	<!-- end: BODY -->
</html><?php /**PATH D:\DEV_SERVER\htdocs\2021\atmserv\coresys\views/layouts/master.blade.php ENDPATH**/ ?>