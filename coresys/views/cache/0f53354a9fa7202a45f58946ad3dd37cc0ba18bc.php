		...
		<div class="toolbar row">
			<div class="col-sm-6 hidden-xs">
				<div class="page-header">
					<h1>KELOLA <small>DATA JABATAN</small></h1>
				</div>
			</div>
		</div>
		<!-- end: TOOLBAR -->
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					<div class="panel-heading">
						...
						<?php // echo anchor(site_url('jabatan/cetak'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Data', 'class="btn btn-warning btn-sm"'); ?>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\2021\atmserv\coresys\views/pages/jabatan/tbl_jabatan_list.blade.php ENDPATH**/ ?>