		...
		<div class="toolbar row">
			<div class="col-sm-6 hidden-xs">
				<div class="page-header">
					<h1>KELOLA <small>DATA PASIEN</small></h1>
				</div>
			</div>
		</div>
		<!-- end: TOOLBAR -->
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var t = $("#mytable").dataTable({
				...
				columns: [
					{"data": "no_rekamedis"},{"data": "no_ktp"},{"data": "no_bpjs"},{"data": "nama_pasien"},{"data": "jenis_kelamin"},{"data": "tempat_lahir"},{"data": "tanggal_lahir"},{"data": "alamat"},{"data": "status_pasien"},
					{
						"data" : "action",
						"orderable": false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\2021\atmserv\coresys\views/pages/pasien/tbl_pasien_list.blade.php ENDPATH**/ ?>