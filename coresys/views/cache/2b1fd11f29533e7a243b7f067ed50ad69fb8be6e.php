		...
		<div class="toolbar row">
			<div class="col-sm-6 hidden-xs">
				<div class="page-header">
					<h1>KELOLA <small>DATA PARAMEDIS</small></h1>
				</div>
			</div>
		</div>
		<!-- end: TOOLBAR -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV_SERVER\htdocs\2021\atmserv\coresys\views/pages/paramedis/tbl_paramedis_list.blade.php ENDPATH**/ ?>