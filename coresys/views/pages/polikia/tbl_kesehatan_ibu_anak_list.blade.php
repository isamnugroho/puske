		...
		<div class="toolbar row">
			<div class="col-sm-6 hidden-xs">
				<div class="page-header">
					<h1>KELOLA <small>DATA KESEHATAN IBU ANAK</small></h1>
				</div>
			</div>
		</div>
		<!-- end: TOOLBAR -->
		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">
						KELOLA DATA KESEHATAN IBU ANAK
					</li>
				</ol>
			</div>
		</div>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					<div class="panel-heading">
						...
						<?php echo anchor(site_url('polikia/cetak'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Cetak Data', 'class="btn btn-success btn-sm"'); ?>
					</div>
