					...
					<div class="panel-body">
						<form role="form" class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form1" name="form1">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="nama_pasien" id="nama_pasien" placeholder="Nama Pasien" value="<?php echo $pendaftaran['nama_pasien'] ?>" onkeyup="pasienauto()" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
									Nama Tindakan <?php echo form_error('nama_operasi') ?>
								</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" value="<?php echo $nama_operasi ?>" name="nama_operasi" id="nama_operasi" placeholder="Nama Tindakan" onkeyup="tindakanauto()" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="biaya" id="biaya" value="<?php echo $biaya ?>" placeholder="Biaya" readonly onkeyup="hitung()" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="dibayar" id="dibayar" value="<?php echo $dibayar ?>" placeholder="Dibayar" onkeyup="hitung()" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="kembalian" id="kembalian" value="<?php echo $kembalian
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
									Tgl Tindakan <?php echo form_error('tgl_tindakan') ?>
								</label>
								<div class="col-sm-9">
									<input type="date" class="form-control" name="tgl_tindakan" value="<?php echo date('Y-m-d') ?>" id="tgl_tindakan" placeholder="Tgl Tindakan" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
								...
								<div class="col-sm-9">
									...
									<a href="<?php echo site_url('polikia') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
								</div>
							</div>
						</form>
					</div>
